...
export default function MyNav({testo, handleChange}) {
    ...
    return (
        <nav className={classNames('flex justify-around items-center py-[18px]', themeCtx === 'dark' ? 'bg-stone-950' : 'bg-stone-100')}>
            ...
            {/* <div>
                <ul className="flex gap-10">
                    <li><a className={classNames('text-white hover:text-indigo-400', themeCtx === 'dark' ? 'text-white' : 'text-black')} href="#">Home</a></li>
                    <li><a className={classNames('text-white hover:text-indigo-400', themeCtx === 'dark' ? 'text-white' : 'text-black')} href="#">About</a></li>
                    <li><a className={classNames('text-white hover:text-indigo-400', themeCtx === 'dark' ? 'text-white' : 'text-black')} href="#">Browse</a></li>
                </ul>
            </div> */}
            <Input testo={testo} handleChange={handleChange}/>
            <button className="bg-slate-300" onClick={toggleTheme}>
                {themeCtx === 'dark' ? (
